package wg.androidgames.framework.gl;

import java.util.ArrayList;
import java.util.List;

import wg.androidgames.framework.GameObject;
...
public class SpatialHashGrid {
    ...
    public int[] getCellIds(GameObject obj) {
        int x1 = (int)FloatMath.floor(obj.bounds.x / cellSize);
        int y1 = (int)FloatMath.floor(obj.bounds.y / cellSize);
        int x2 = (int)FloatMath.floor((obj.bounds.x + obj.bounds.width) / cellSize);
        int y2 = (int)FloatMath.floor((obj.bounds.y + obj.bounds.height) / cellSize);
